...
function readFormData() {
  ...
  formData["stuCol"] = document.getElementById("stuCol").value;
  formData["stuCou"] = document.getElementById("stuCou").value;
  return formData;
}
function resetForm() {
  document.getElementById("stuName").value = "";
  document.getElementById("stuCol").value = "";
...
document.getElementById("stuCol").value=selectedRow.cells[1].innerHTML;
...
selectedRow.cells[1].innerHTML=formData.stuCol;
