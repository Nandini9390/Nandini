...
if(a==""|| a==null || isNaN(a)==false ){ alert("please enter the Name");return false;}
var  b = document.getElementById("facDep").value;
if(b==""|| b==null || isNaN(b)==false ){alert("please enter the Dep");return false;}
var c= document.getElementById("facSub").value;
if(c==""|| c==null || isNaN(c)==false ){alert("please enter the Sub");return false;}
var d= document.getElementById("facAge").value;
if(isNaN(d)|| d<18|| d>65){alert("please enter the Age between 18 to 65");return false;}
var e= document.getElementById("facPlace").value;
if(e==""|| e==null || isNaN(e)==false ){alert("please enter the place");return false;}
else
{return true;}
