Day 2 Django tutorial tailored for absolute beginners. This tutorial covers the essential setup and helps you build your first Django project step-by-step.
...
def home(request):
    return HttpResponse("Hi, Nandini!")
________________________________________
